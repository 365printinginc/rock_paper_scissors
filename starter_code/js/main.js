...
$(".rock").mouseenter(mouseEnter);
	function mouseEnter(){
		event.preventDefault();
		$(this).css('border', '10px solid red'); 
	}

$(".rock").mouseleave(mouseLeave);
	function mouseLeave(){
		event.preventDefault();
		$(this).css('border', '5px solid'); 
	}

$(".paper").mouseenter(mouseEnter);
	function mouseEnter(){
		event.preventDefault();
		$(this).css('border', '10px solid red'); 
	}

$(".paper").mouseleave(mouseLeave);
	function mouseLeave(){
		event.preventDefault();
		$(this).css('border', '5px solid'); 
	}

$(".scissors").mouseenter(mouseEnter);
	function mouseEnter(){
		event.preventDefault();
		$(this).css('border', '10px solid red'); 
	}

$(".scissors").mouseleave(mouseLeave);
	function mouseLeave(){
		event.preventDefault();
		$(this).css('border', '5px solid'); 
	}
